...
function taskCard(task) {
  return `<div class="task-card p-4 rounded-2xl border border-zinc-300 shadow-md">
                <div class="flex items-start gap-2">
                        <div class="dragIcon">
                            <i class="hgi hgi-stroke hgi-rounded hgi-drag-drop-vertical text-xl"></i>
                        </div>
                        <div class="task_details flex-1 min-w-0">
                            <h2 class="text-lg font-medium mb-1 break-all">${task.title}</h2>
                            <p class="text-sm text-zinc-400 break-all">${task.description}</p>
                        </div>
                </div>
